...
> 作者：[@沐华](https://juejin.cn/user/3368559359825448)，本文已授权稀土掘金技术社区公众号独家使用，包括但不限于编辑、标注原创等权益。
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8647013eded4852af7041ee5d8d492f~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![diff.jpg](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/df749067cf03454ca8cb4c78067a3407~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![diff1.jpg](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ca7547df4fb24a12ae9c87d1733b78b6~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)

**2. 比较标签名**

如果同一层级的比较标签名不同，就直接移除老的虚拟 DOM 对应的节点，不继续按这个树状结构做深度比较，这是简化比较次数的第二个方面

![diff2.jpg](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2fc6b71c2f9f4e069f878e816ac66f97~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![diff3.jpg](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0dee9fb8ad4243e094c68448716fc13e~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![diff4.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1882d22f62b4433aa0a91dcbe0ad09d5~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![diff2.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b89cbc2280940038f5550bf9b7370aa~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
```js
js
复制代码function updateChildren (parentElm, oldCh, newCh, insertedVnodeQueue, removeOnly) {
...
```js
js
复制代码<button @click="handleClick">按钮</button>
```
...
```js
js
复制代码export function render(_ctx, _cache, $props, $setup, $data, $options) {
...
- [22个高频JavaScript手写代码了解一下](https://juejin.cn/post/6996289669851774984)
